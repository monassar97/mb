...
export const mainMenu: MainMenuLink[] = [
    ...
    //                         url: '/shop/category-columns-4-full',
    //                     },
    //                     {
    ...
    //                         url: '/shop/category-columns-6-full',
    //                     },
    //                     {
    ...
    //                     {
    //                         title: '5 Columns Full',
    //                         url: '/shop/shop-grid-5-full',
    //                     },
    //                     {
    //                         title: '4 Columns Full',
    //                         url: '/shop/shop-grid-4-full',
    //                     },
    //                     {
    //                         title: '4 Columns Sidebar',
    //                         url: '/shop/shop-grid-4-sidebar',
    ...
    //     title: 'Buy Theme',
    //     url:
    //         'https://themeforest.net/item/redparts-auto-parts-angular-template/27087440',
    //     external: true,
    //     customFields: {
    //         ignoreIn: ['spaceship'],
    //     },
