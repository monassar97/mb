import {
    ProductAttributesDef,
    ProductDef,
    PropertyModel,
} from '../interfaces/product-def';
...
const productsDef: ProductDef[] = [
    {
        ...
        price: 19,
        images: [
            'https://a0.muscache.com/im/pictures/ef92ae43-7207-43d9-9ce7-100beaf4403e.jpg?aki_policy=large',
            'https://a0.muscache.com/im/pictures/15392012-65e8-4452-b5bd-968c5cd29b06.jpg?aki_policy=large',
            'https://a0.muscache.com/im/pictures/ca62dacb-7260-40d1-9838-edf2d5252679.jpg?aki_policy=large',
            'https://a0.muscache.com/im/pictures/ca62dacb-7260-40d1-9838-edf2d5252679.jpg?aki_policy=large',
        ],
        badges: ['sale', 'new', 'hot'],
        rating: 4,
